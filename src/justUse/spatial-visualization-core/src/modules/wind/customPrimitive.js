...
import { defined, defaultValue, destroyObject, Pass } from './cesiumCompat.js'
...
export default class CustomPrimitive {
    ...
    update(frameState) {
        ...
        if (!defined(this.commandToExecute)) {
            ...
            if (this._pendingVertexArray && this.commandToExecute) {
                this.commandToExecute.vertexArray = this._pendingVertexArray;
                this._pendingVertexArray = undefined;
            }
        }
